...
<div class="hero-section text-center">
    <div class="container">
            ...
            <div class="col-md-8 col-lg-6">
                <form action="wisata.php" method="GET" class="d-flex bg-white p-2 rounded-pill shadow-lg">
                    ...
                    <input type="text" name="q" 
                        class="form-control border-0 rounded-pill ps-3 shadow-none" 
        ...
        <div class="mt-4">
            <a href="wisata.php" class="btn btn-outline-light btn-sm rounded-pill px-3">
                Lihat Semua Daftar
            </a>
        </div>
    </div>
...
<div class="container mb-5">
    <h3 class="mb-4 border-bottom pb-2">
        <i class="bi text-danger me-2"></i>Wisata Paling Trending
    </h3>
